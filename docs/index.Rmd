...
[![](https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Men_at_work_sign_%28green%29.svg/996px-Men_at_work_sign_%28green%29.svg.png){width=10%}](http://swcarpentry.github.io/r-novice-inflammation/02-func-R/index.html)**Writing functions in R**
...
- Write an R function that carries out a permutation test as above taking 
     ...
     - a date range specifying treatment limits as arguments.
- This function shoud output a vector of permuted means. 
- Include an option to either carry out the permutation test on 
     - the raw or 
     - standardised values. 
- Use the function on the lovebird and budgie data to carry out two hypothesis tests that the observed raw means are equal to any other permuted mean.  
- Use this function to test the hypothesis that the observed sum of the budgie and lovebird standardised means during treatment is equal to any other possible permuted combinations.
